...
- ✅ **流量信息显示**：支持 Subscription-UserInfo 标头，实时显示用量 (v2.8.56+)
- ✅ **订阅特征配置**：自动设置订阅名称 (Email) 及 12 小时更新间隔 (v2.8.56+)
- ✅ **动态低速专线**：自动生成 xcdn 节点，分组自动排序至末尾 (v2.8.75+)
- ✅ **负载均衡策略**：显式设置 round-robin 策略，确保流量均匀分配 (v2.8.76+)
